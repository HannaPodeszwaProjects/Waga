...
public:
	...
	*/
	...
	/**Operator +=
	@param Gracz wskaznik na obiekt Gracz
	@return Operator zwraca wskaznik na Gracz
	*/
	Gracz* operator+=(Gracz *);
	...
	@return Funkcja  zwraca wejscie
	*/
	friend istream& operator>>(istream& input, Wynik& w);
};
